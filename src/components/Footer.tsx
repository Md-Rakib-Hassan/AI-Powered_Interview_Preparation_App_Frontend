...
import { Laptop, Twitter, Facebook, Instagram, Linkedin, Mail, Phone } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              AI-powered interview preparation for professionals. Practice, get feedback, and land your dream job.
            </p>
