    ...
    <div className="bg-white border border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 relative group" onClick={onSelect}>
      <div className="rounded-lg p-4 cursor-pointer relative" style={{ background: colors.bgcolor }}>
        <div className="flex items-start">
          ...
          <div className="flex-grow">
            ...
            <h2 className="text-[17px] font-bold">{role}</h2>
            <p className="text-xs text-medium text-gray-600">{topicsToFocus}</p>
          </div>
        </div>
        ...
        <button
          ...
          onClick={(e) => {
            ...
            onDelete();
              ...
              >
            <LucideTrash2 className="text-[8px]"></LucideTrash2>
        </button>
      </div>
      ...
      <div className="px-3 pb-3">
        <div className="flex item-center gap-3 mt-4">
          ...
          <div className="text-[10px] font-medium text-black px-3 py-1 border-[0.5px] border-gray-900 rounded-full">Last Update: {lastUpdated}</div>
        </div>
